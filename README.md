...
File a GitHub [issue](https://github.com/sevenpicocomponents/terraform-aws-ses/issues), send us an [email][email] or join our [Slack Community][slack].
...
Please use the [issue tracker](https://github.com/sevenpicocomponents/terraform-aws-ses/issues) to report any bugs or file feature requests.
